...
return(
    <div>
<div class="card">
  <h5 class="card-header">Computer Hardware Engineers</h5>
  <div class="card-body">
...
<div class="card">
  <h5 class="card-header"> Computer Programmers</h5>
  <div class="card-body">
    <h5 class="card-title">More Information</h5>
...
<div class="card">
  <h5 class="card-header">Network and Computer Systems Administrators</h5>
  <div class="card-body">
    <h5 class="card-title">More Information</h5>
...
<div class="card">
  <h5 class="card-header">Computer Support Specialists</h5>
  <div class="card-body">
    <h5 class="card-title">More Information</h5>
...
<div class="card">
  <h5 class="card-header">Software Developers, Quality Assurance Analysts, and Testers</h5>
  <div class="card-body">
    <h5 class="card-title">More Information</h5>
...
<div class="card">
  <h5 class="card-header">Information Security Analysts</h5>
  <div class="card-body">
    <h5 class="card-title">More Information</h5>
