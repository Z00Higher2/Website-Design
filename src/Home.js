        ...
        <div>
           <div class="container-head">
            ...
            <div class="col-12 col-lg-6 align-left">
                ...
                <h1 class="mbr-section-title mbr-white mbr-fonts-style mb-4 display-2" id="head1"><strong style={{textAlign: "center"}}>TECH FUTURE</strong></h1>
            ...
            <p className="line2">With Over Thousands of Jobs in this field of study</p>
            <p className="line3">Make your dream a Reality</p>
            <p className="line4">Code many Computer Languages</p>
